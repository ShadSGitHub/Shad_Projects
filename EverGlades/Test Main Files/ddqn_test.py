...
#players[0].qnetwork_local.state_dict() = load_state_dict(torch.load('checkpoint.pth'))
...
for i_episode in range(1, n_episodes+1):
    ...
    if i_episode>100 and np.mean(scores_deque)>=0.99:
        ...
        torch.save(players[0].actor_local.state_dict(), 'checkpoint.pth')
        break
